package com.wcl.uustore.widget.viewpage;
...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(AppTools.dpToPx(getResources(), 2));
        mOutlinePaint.setColor(Color.BLUE);
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = AppTools.dpToPx(getResources(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = AppTools.dpToPx(getResources(), 5);
